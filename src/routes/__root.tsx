...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Le Radial SRL — Ultra High Performance | Cubiertas y neumáticos" },
      { name: "description", content: "Le Radial SRL — Ultra High Performance. Venta de cubiertas y neumáticos para autos, camionetas, camiones, agrícolas e industriales. Envíos a toda la Argentina." },
      { name: "author", content: "Le Radial SRL" },
