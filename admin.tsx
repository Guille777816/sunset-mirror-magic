...
function AdminPage() {
  ...
  // Estado de autenticación corregido (empieza en false)
  ...
  // Verificación de sesión de Supabase activada
  useEffect(() => {
  ...
  if (!ready) {
    return <div className="p-10 text-center font-semibold text-muted-foreground">Verificando sesión...</div>;
  }
    ...
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4" onClick={onCancel}>
      <div className="w-full max-w-lg rounded-2xl bg-card p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Field label="URL de imagen (o pegá enlace)" col2>
            <input
              className={input}
          ...
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" checked={p.is_active} onChange={(e) => set("is_active", e.target.checked)} /> Activo
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" checked={p.is_featured} onChange={(e) => set("is_featured", e.target.checked)} /> Promo
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" checked={p.free_shipping} onChange={(e) => set("free_shipping", e.target.checked)} /> Envío gratis
          </label>
        </div>
...
type Settings = {
  ...
  promo_banner: string; logo_url: string; hero_image_url: string;
    ...
    <div className="space-y-6">
      <div className="rounded-2xl bg-card p-6 shadow-[var(--shadow-product)]">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <Field label="Instagram"><input className={input} value={s.instagram} onChange={(e) => set("instagram", e.target.value)} /></Field>
          <Field label="Facebook"><input className={input} value={s.facebook} onChange={(e) => set("facebook", e.target.value)} /></Field>
